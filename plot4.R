...
plot(b,x,type="l",lwd="1",xlab="",ylab="Global Active Power")

x4<-as.numeric(as.character(t$Voltage))

plot(b,x4,type="l",lwd="1",xlab="datetime",ylab="Voltage")
...
x5<-as.numeric(as.character(t$Global_reactive_power))

plot(b,x5,type="l",lwd="1",xlab="datetime",ylab="Global_reactive_power")
